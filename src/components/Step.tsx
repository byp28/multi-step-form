...
export default function Step({step} : {step:IStep}) {
  ...
  return (
    <div className="w-full flex max-lg:flex-col max-lg:w-10  gap-5 items-center max-lg:justify-center max-lg:gap-2">
        <span className={`${activeStep ? "bg-[#BEE1FD]" : "text-[#BEE1FD]"} border max-lg:border-2 border-[#BEE1FD] cursor-pointer w-12 h-12 max-lg:w-10 max-lg:h-10 rounded-full flex items-center justify-center z-2`}>
            {step.stepNumber}
        </span>
